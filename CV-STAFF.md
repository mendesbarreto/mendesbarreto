<div class="header" style="margin-bottom: 10px;">
  ...
  <h3 style="margin: 0;">Staff Software Engineer</h3>
  <p>
...
**Senior Software Engineering Manager / Staff-Level Technical Lead**
...
- Developed enterprise web applications using J2EE, JSP, JSF, and SOAP web services
- Designed MySQL-backed data workflows and reporting integrations with JasperReports
- Built parsers and automation scripts for SMS, XML, and CSV data processing
